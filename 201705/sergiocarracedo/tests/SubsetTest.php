...
final class SubsetTest extends TestCase {
  public function testExamplesMustBeFalse() {
    $examples = [
      [1, 2, 3],
      []
    ];
  ...
  public function testExamplesMustBeTrue() {
    $examples = [
      [-5, -3, -1, 2, 4, 6],
      [-1, 1],
  ...
  public function testExamplesMustBeFalse2items() {
    $examples = [
      [1, 2, 3],
      [-5, -3, -1, 2, 4, 6],
      [],
    ...
    foreach($examples as $example) {
      $subset = new Subset($example);
      $this->assertFalse($subset->checkNulls2Items());
    }

  }

  public function testExamplesMustBeTrue2items() {
    $examples = [
      [-2, 2, 3],
      [-1, 1],
      [-97364, -71561, -69336, 19675, 71561, 97863],
    ...
    foreach($examples as $example) {
      $subset = new Subset($example);
      $this->assertTrue($subset->checkNulls2Items());
    }
  }
